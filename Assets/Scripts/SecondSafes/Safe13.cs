...
public class Safe13 : MonoBehaviour 
{
	...
	void res13()
	{
		if(Screen.width==1366&&Screen.height==768){
			Text_13.transform.position = new Vector2(0.538f,0.685f);
		...
		if(Screen.width==640&&Screen.height==480){
			Text_13.transform.position = new Vector2(0.54f,0.685f);
		...
		if(Screen.width==1280&&Screen.height==600){
			Text_13.transform.position = new Vector2(0.53f,0.685f);
